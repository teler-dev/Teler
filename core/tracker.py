...
class MainWindow(QMainWindow):
    ...
    def __init__(self, username="", organization_name="", job_role="general", organization_id="",
        ...
        control_card.setMaximumWidth(760)
        control_card.setMinimumWidth(660)
        control_card_row = QHBoxLayout()
        control_card_row.setContentsMargins(72, 0, 72, 0)
        control_card_row.setSpacing(0)
        control_card_row.addStretch(1)
        control_card_row.addWidget(control_card)
        control_card_row.addStretch(1)
        layout.addLayout(control_card_row)
