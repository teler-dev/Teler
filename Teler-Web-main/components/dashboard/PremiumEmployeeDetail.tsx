...
export const Dashboard:React.FC<Props>=({onLogout,userName='User',initialEmployee,onBack})=>{
  ...
  const [autoReport,setAutoReport]=useState<{status:string;summary?:string;confidence?:number;error_message?:string;findings?:Array<{screenshot_id:string;summary:string;confidence?:number}>}|null>(null);
