      ...
      <PageContainer>
        ...
        {loading&&!selected?<LoadingState variant="detail" label="Loading employee telemetry" />:selected?<>
          ...
          <section className="bg-surface-card border border-subtle rounded-2xl px-4 py-3.5 md:px-5" aria-label="Activity basis">
            ...
            <p className="text-xs text-secondary mt-3 pt-3 border-t border-subtle">Active time currently resets on keyboard input or mouse clicks. Reading, mouse movement, and scrolling alone may still be counted as idle.</p>
          </section>
