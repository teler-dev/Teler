...
import { StatusDot, StatusTone } from '../ui/StatusBadge';
  ...
  return <div className="min-h-screen bg-surface-page text-primary flex">
    ...
    <div className="flex-1 ml-56 min-w-0 min-h-screen">
      <PageHeader
        ...
        title="Employees"
        description={`${rows.length} team members · ${counts.working} working · ${counts.idle} idle · ${counts.offline} offline`}
