    ...
    <div className="flex-1 ml-56 min-w-0 min-h-screen">
      <header className="sticky top-0 z-30 bg-surface-page/90 backdrop-blur-xl border-b border-subtle">
        <div className="px-4 md:px-6 py-3">
          {kind === 'analytics' && <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-accent">Workforce Intelligence</p>}
          <h1 className="text-2xl md:text-3xl font-bold text-primary mt-1">{meta.title}</h1>
          <p className="text-sm text-secondary mt-1 max-w-3xl">{meta.description}</p>
        </div>
      </header>
